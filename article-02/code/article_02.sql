/*
 * The code in this file is automatically generated @ 2023-05-19 13:03:18.518895.
...
CREATE OR ALTER PROCEDURE [orders_stg].[usp_load_Customer] (
...
CREATE OR ALTER PROCEDURE [orders_stg].[usp_load_Product] (
  @stg_runId uniqueIdentifier
, @stg_timestamp_utc datetime
)
AS
...
CREATE OR ALTER PROCEDURE [orders_stg].[usp_load_Order] (
  @stg_runId uniqueIdentifier
, @stg_timestamp_utc datetime
)
AS
